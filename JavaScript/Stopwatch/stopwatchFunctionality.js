...
//Another thing I noticed is that when called for function stop(). The time appeared may be miliseconds delayed. This can be due to the calculations time. I think it can be better?
...
//This basically complete the rest of the row. Notice there is a slight delay, this is probably due to google's api reply and the functions that we are processing.
...
function addTimeZone(pos,timeZoneNow){
let requestString = "http://api.timezonedb.com/v2.1/get-time-zone?key=L2P7AG84V1GC&format=json&by=position&lat=" + pos.lat + "&lng=" + pos.lng;
...
//WORK ON STORING THESE APIS CALL
}
